...
export function AnimationPreview({ frames, showGuidelines }: Props) {
  ...
  return (
    <div style={{
      ...
      <h3 style={{ margin: 0, fontSize: 10, fontWeight: 900, color: '#444', textTransform: 'uppercase', letterSpacing: '0.1em' }}>
        Preview da Animação
      </h3>
      ...
      {/* Frame counter */}
      <span className="text-mono" style={{ fontSize: 10, color: '#fff' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <CtrlBtn
          ...
          style={{ background: playing ? 'rgba(255,255,255,0.05)' : '#fff', color: playing ? '#fff' : '#000', minWidth: 64 }}
        >
          {playing ? '⏸ Pause' : '▶ Play'}
        </CtrlBtn>
      ...
      <div style={{ width: '100%', maxWidth: 260 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 9, color: '#444', textTransform: 'uppercase', marginBottom: 6 }}>
